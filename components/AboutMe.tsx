...
function AboutMe() {
    ...
    return (<>
        <div className=' h-auto flex justify-between flex-col md:flex-row items-center z-10'>
            ...
            <div className='z-30 mt-7 ring-8 rounded-full ring-white'>
                <Image
                    src="/profile.png"
                    width={300}
                    height={300}
        ...
        <div>
            ...
            <p className='text-justify capitalize'>
                ...
                Hi, I’m <strong>Tauhidul Islam,</strong> an aspiring MERN Stack Developer with a strong focus on front-end development. My journey into web development began at the end of 2023 with a deep curiosity about how websites work. What started as exploration quickly grew into a full-fledged passion and career goal.
                ...
                I am continuously learning, improving my problem-solving skills, and working on real-world projects to strengthen my development expertise. My goal is to grow as a professional developer and contribute to impactful web applications.
